...
export function ProductCardSkeleton() {
  return (
    <div className="flex flex-col rounded-xl border border-gray-200 bg-white shadow-sm overflow-hidden animate-pulse">
      {/* Image placeholder */}
      ...
      <div className="flex flex-col gap-2 p-4">
        ...
        <div className="h-3 w-20 bg-gray-200 rounded-full mt-1" />
